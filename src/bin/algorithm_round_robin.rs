...
use cav2021_artifact::algorithms::{find_attractors_lockstep, round_robin_reduction};
...
fn main() {
    ...
    let (universe, variables) = round_robin_reduction(&graph, graph.unit_colored_vertices());
