...
use cav2021_artifact::algorithms::{find_attractors_lockstep, priority_reduction};
...
fn main() {
    ...
    let (universe, variables) = priority_reduction(&graph, graph.unit_colored_vertices());
